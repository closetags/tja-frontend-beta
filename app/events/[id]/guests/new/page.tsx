...
import { ArrowLeft, UserPlus, Mail, Phone, User, CheckCircle2, Users } from 'lucide-react';
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (errorData.email) {
          ...
          setError(errorData.message || 'Failed to add guest');
        }
      }
    } catch (error) {
        ...
        <div className="bg-white rounded-[40px] shadow-2xl shadow-teal-500/10 border border-white/50 overflow-hidden">
          <div className="p-8 md:p-12">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-800">Add Guest</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    value={formData.name}
                    onChange={handleChange}
                    placeholder="Enter guest's full name (e.g., Moses Adole)"
                    required
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-700 mb-2">
                      <span className="font-semibold">Note:</span> At least one contact method (email or phone) is required. The guest will receive an invitation QR code via the provided contact information.
                    </p>
